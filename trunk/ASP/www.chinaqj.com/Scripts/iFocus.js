...
function iFocusChange() {
    ...
    iFocusBtns[0].onmouseover = function() {
        moveElement('ifocus_piclist',0,0,8);
        classNormal('ifocus_btn','ifocus_tx');
        classCurrent('ifocus_btn','ifocus_tx',0);
    }
    if (listLength>=2) {
        iFocusBtns[1].onmouseover = function() {
            moveElement('ifocus_piclist',0,-452,8);
            classNormal('ifocus_btn','ifocus_tx');
    ...
    if (listLength>=3) {
        iFocusBtns[2].onmouseover = function() {
            moveElement('ifocus_piclist',0,-904,8);
            classNormal('ifocus_btn','ifocus_tx');
    ...
    if (listLength>=4) {
        iFocusBtns[3].onmouseover = function() {
            moveElement('ifocus_piclist',0,-1356,8);
            classNormal('ifocus_btn','ifocus_tx');
    ...
    if (listLength>=5) {
        iFocusBtns[4].onmouseover = function() {
            moveElement('ifocus_piclist',0,-1808,8);
            classNormal('ifocus_btn','ifocus_tx');
    ...
    if (listLength>=6) {
        iFocusBtns[5].onmouseover = function() {
            moveElement('ifocus_piclist',0,-2260,8);
            classNormal('ifocus_btn','ifocus_tx');
	...
	if (listLength>=7) {
        iFocusBtns[6].onmouseover = function() {
            moveElement('ifocus_piclist',0,-2712,8);
            classNormal('ifocus_btn','ifocus_tx');
	...
	if (listLength>=8) {
        iFocusBtns[7].onmouseover = function() {
            moveElement('ifocus_piclist',0,-3164,8);
            classNormal('ifocus_btn','ifocus_tx');
