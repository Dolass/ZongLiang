...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
  ...
  <tr>
    <td bgcolor="#FFFFFF" style="line-height:25px; padding:6px 12px;"><%=ChinaQJOthers("0",13,28)%></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" style="text-align:right; padding:5px 8px 8px 8px;"><a href="Info.html"><img src="<%=StylePath%>more3_c.gif" border="0" title="更多常见问题"></a></td>
  </tr>
</table>
...
-->
    ...
    <td valign="top" style="padding:0px 5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="background-color:#FFF; border:1px #ccc solid; padding:8px; line-height:20px; font-weight:normal; height:auto; overflow:hidden;"><%= ReStrReplace(StrLeft(sitedetail,460)) %></td>
      </tr>
    </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
        <tr>
