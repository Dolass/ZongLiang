...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="contentcenter"><div class="contentnav"><%=ChinaQJProductBuyWebLocation()%></div></td>
  </tr>
  <tr>
    <td class="contentcenter"><%Call ChinaQJProductBuyProductList()%></td>
  </tr>
  <tr>
    <td class="contentcenter"><%Call ChinaQJProductBuyForm()%></td>
  </tr>
  <tr>
