...
<%
If session("AdminName") = "" Or session("UserName") = "" Or session("AdminPurview") = "" Or session("LoginSystem") <> "Succeed" Or InStr(session("AdminPurview"), "|42,") = 0 Or (EnableSiteManageCode = 1 And Trim(Request.Cookies("AdminLoginCode")) <> SiteManageCode) Then
...
.WriteText=s_Text
.SaveToFile server.mappath(s_FileName),2
.Close
End With
