...
config.AllowMediaExt = "rm|mp3|wav|mid|midi|ra|avi|mpg|mpeg|asf|asx|wma|mov|flv";
...
config.Toolbars = [
	...
	["TBHandle", "Image", "Flash", "Media", "File", "GalleryMenu", "TBSep", "TableMenu", "FormMenu", "TBSep", "Fieldset", "Iframe", "HorizontalRule", "Marquee", "CreateLink", "Unlink", "Map", "Anchor", "TBSep", "Template", "Symbol", "Emot", "Art", "Excel", "Quote", "ShowBorders", "TBSep", "Maximize", "PrintBreak"]
];
