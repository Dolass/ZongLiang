...
str = str & "<!-- "
str = str & "Baidu XML File Generated by http://www.chinaqj.com "&chinaqjtime&""
str = str & "-->" & vbcrlf
str = str & "<document xmlns:bbs='http://www.baidu.com/search/bbs_sitemap.xsd'>" & vbcrlf
str = str & "<webSite>"&server.htmlencode(session("server"))&"</webSite> " & vbcrlf
str = str & "<webMaster>"&JMailInFrom&"</webMaster> " & vbcrlf
str = str & "<updatePeri>3</updatePeri> " & vbcrlf
str = str & "<updateTime>"&now()&"</updateTime> " & vbcrlf
...
.WriteText=str
.SaveToFile server.mappath("/baidu.xml"),2 '生成的XML文件名
.Close
End With

Set objStream = Nothing
If Not Err Then
Response.Write("<br />&nbsp;&nbsp;秦江陶瓷为您提供适用于百度的XML文件。<br />&nbsp;&nbsp;Baidu.xml生成完毕，共<font color='#FF0000'> "&ChinaQJRSS&" </font>条记录被索引。<br />&nbsp;&nbsp;点击查看 <a href='../baidu.xml' target='_blank'><font color='#FF0000'><u>baidu.xml</u></font></a> <a href='http://news.baidu.com/newsop.html' target='_blank'><u>立即提交至百度</u></a>")
Response.End
End If
...
getfilelink = "<item><link>"&server.htmlencode(session("server")&file)&"</link><pubDate>"&filedate&"</pubDate></item>"
Response.Flush
