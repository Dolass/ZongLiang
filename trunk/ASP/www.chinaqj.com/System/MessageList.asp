...
function GetMessageList()
	...
	If request.QueryString("Result")="Search" and request.QueryString("Keyword")<>"" Then				'搜索关键字
		SqlWhere=" MesName LIKE '%"&request.QueryString("Keyword")&"%'"	'where
	End If
...
set rs2=nothing
    ...
    response.write "<tr><td nowrap align='center' colspan='10' class=""forumRow"">暂无留言信息</td></tr>"
  end if
  Response.Write "<tr>" & vbCrLf
