...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
  ...
  <tr>
    <td bgcolor="#FFFFFF" style="text-align:right; padding:5px 8px 8px 8px;"><a href="Info.html"><img src="<%=StylePath%>more3_c.gif" border="0" title="より多くのよくある質問"></a></td>
  </tr>
</table>
<!--
...
-->
    ...
    <td valign="top" style="padding:0px 5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="background-color:#FFF; border:1px #ccc solid; padding:8px; line-height:20px; font-weight:normal; height:125px; overflow:hidden;"><%= ReStrReplace(StrLeft(sitedetail,574)) %></td>
      </tr>
    </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
        <tr>
          ...
          <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:url(<%=StylePath%>bg_sear.gif) no-repeat 2px 24px;">
            ...
            <tr>
              <td height="28"><%=ChinaQJLanguageTxt264%>
                <%Call ChinaQJSearchCount(10,15,"")%></td>
              </tr>
            <tr>
