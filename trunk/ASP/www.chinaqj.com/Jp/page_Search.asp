...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="contentcenter"><div class="contentnav"><%=ChinaQJSearchWebLocation()%></div></td>
  </tr>
  <tr>
    <td class="contentcenter"><%=ChinaQJSearchWebContent(trim(request("Keyword")),request("Range"))%></td>
  </tr>
  <tr>
