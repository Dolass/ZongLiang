  ...
  <tr>
    ...
    <td valign="top" style="padding:0px 5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<div style="float:right; font-size:12px;"><a href="Introduction-1.html"><%= ChinaQJLanguageTxt30 %></a></div>
        </td>
      </tr>
      <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
        <tr>
          <td class="centertitle"><div style="float:left;"><%= ChinaQJLanguageTxt297 %></div>
            <div style="float:right; font-size:12px;"><a href="New.html"><%= ChinaQJLanguageTxt30 %></a></div></td>
        </tr>
        <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
        <tr>
          <td class="centertitle"><div style="float:left;"><%= ChinaQJLanguageTxt295 %></div>
            <div style="float:right; font-size:12px;"><a href="Product.html"><%= ChinaQJLanguageTxt30 %></a></div></td>
        </tr>
        <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
  ...
  <tr>
    <td bgcolor="#FFFFFF" style="text-align:right; padding:0px 8px 8px 8px;"><a href="Info.html"><img src="<%=StylePath%>more3_c.gif" border="0"/></a></td>
  </tr>
</table>
    </td>
  </tr>
