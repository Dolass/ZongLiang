...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="leftnavtop"><%= ChinaQJLanguageTxt22 %></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="contentcenter"><div class="contentnav"><%=ChinaQJMemberRegisterWebLocation()%></div></td>
  </tr>
  <tr>
    <td class="contentcenter"><%Call ChinaQJMemberRegisterForm()%></td>
  </tr>
  <tr>
