...
<Script>if(self!=top){top.location=self.location;}</script>
	<div id="head">
		<div class="left"><img src="images/sdcms_logo.gif" alt="SDCMS网站信息管理系统"/></div>
		...
		<div class="right head_menu">
		  <ul id="head_menu">
			  ...
			  <li><a href="http://help.sdcms.cn" target="_blank">帮助中心</a></li>
			  <li><a href="http://www.sdcms.cn" target="_blank">官方网站</a></li>
		  </ul>
		</div>	
	</div>
<!--head is over-->
