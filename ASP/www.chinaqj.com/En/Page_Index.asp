...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:3px;">
  <tr>
    <td class="lefttitleproduct"><%= ChinaQJLanguageTxt291 %></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><div id="quick"><%=ChinaQJIndexLeftNavigation(10)%></div></td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
  <tr>
    <td class="righttitlefaq"><%= ChinaQJLanguageTxt310 %></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" style="line-height:25px; padding:6px 12px;"><%=ChinaQJOthers("0",13,30)%></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" style="text-align:right; padding:5px 8px 8px 8px;"><a href="Info.html"><img src="<%=StylePath%>more3.gif" border="0" title="More FAQ"></a></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
  <tr>
    <td class="lefttitlevideo"><%= ChinaQJLanguageTxt307 %></td>
  </tr>
  <tr>
...
-->
    ...
    <td valign="top" style="padding:0px 5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<div style="float:right; font-size:12px; font-weight:normal;"><a href="Introduction-1.html"><%= ChinaQJLanguageTxt311 %></a></div>
        </td>
      </tr>
      <tr>
        <td style="background-color:#FFF; border:1px #ccc solid; padding:8px; line-height:20px; font-weight:normal; height:125px; overflow:hidden;"><%= ReStrReplace(StrLeft(sitedetail,460)) %></td>
      </tr>
    </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
        <tr>
          <td class="centertitlenews"><div style="float:left;"><%= ChinaQJLanguageTxt297 %></div>
            <div style="float:right; font-size:12px; font-weight:normal;"><a href="New.html"><%= ChinaQJLanguageTxt311 %></a></div></td>
        </tr>
        <tr>
          <td style="background-color:#FFF; border:1px #ccc solid; padding:8px; line-height:20px;"><%=ChinaQJIndexNews("0,",7,42)%></td>
        </tr>
    </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
        <tr>
          <td class="centertitlehot"><div style="float:left;"><%= ChinaQJLanguageTxt308 %></div>
            <div style="float:right; font-size:12px; font-weight:normal;"><a href="Product.html"><%= ChinaQJLanguageTxt311 %></a></div></td>
        </tr>
        <tr>
          <td style="background-color:#FFF; border:1px #ccc solid; padding:8px; line-height:20px;"><%=ChinaQJIndexProducts("0,",3,3,144,107,2)%></td>
        </tr>
    </table></td>
    <td width="235" valign="top">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
  <tr>
    <td class="righttitlecase"><%= ChinaQJLanguageTxt309 %></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" style="padding:8px;"><%=ChinaQJIndexImage("0,",6,2,101,61)%></td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
  <tr>
