...
<%
	'Call BetaNewSo("JobsList.asp","","NewFlagCh","新品")
	'Call BetaNewSo("JobsList.asp","","CommendFlagCh","推荐")
	Call BetaNewSo("JobsList.asp","NOT ","ViewFlagCh","中文未显示")
	Call BetaNewSo("JobsList.asp","NOT ","ViewFlagEn","英文未显示")
	Call BetaNewSo("JobsList.asp","NOT ","ViewFlagJp","日文未显示")
%>
  </td></tr>
  </form>
</table>
...
function GetJobsList()
	...
	If request.QueryString("Result")="Search" and request.QueryString("Keyword")<>"" Then				'搜索关键字
		SqlWhere=" JobNameCh LIKE '%"&request.QueryString("Keyword")&"%'"	'where
	End If
	...
	Else
		Do While Not rs.eof
			...
			if StrLen((rs("JobNameCh")))>40 Then
				Response.Write "<td nowrap title='"&rs("JobNameCh")&"' class=""forumRow""><a href='JobsEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&StrLeft(rs("JobName"),37)&"</a></td>"
			Else
				Response.Write "<td nowrap title='"&rs("JobNameCh")&"' class=""forumRow""><a href='JobsEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&rs("JobNameCh")&"</a></td>"
			end if 
			Response.Write "<td nowrap class=""forumRow"">"&rs("JobNumber")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("EndDate")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("AddTime")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("TalentsNumber")&"人</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("ClickNumber")&"</td>"
			Response.Write "<td align=""center""nowrap class=""forumRow""><a href='JobsEdit.asp?Result=Modify&ID="&rs("ID")&"'>修改</a></td>"
...
function JobsList()
  ...
  dim datawhere
      if Result="Search" then
	     datawhere="where JobNameCh like '%" & Keyword &_
		           "%' "
	  else
	    if SortPath<>"" then
...
set rs2=nothing
	  if StrLen((rs("JobNameCh")))>40 then
        Response.Write "<td nowrap title='"&rs("JobNameCh")&"' class=""forumRow""><a href='JobsEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&StrLeft(rs("JobName"),37)&"</a></td>" & vbCrLf
      else
        Response.Write "<td nowrap title='"&rs("JobNameCh")&"' class=""forumRow""><a href='JobsEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&rs("JobNameCh")&"</a></td>" & vbCrLf
      end if 
      ...
      Response.Write "<td align=""center""nowrap class=""forumRow""><a href='JobsEdit.asp?Result=Modify&ID="&rs("ID")&"'>修改</a></td>" & vbCrLf
    ...
    response.write "<tr><td nowrap align='center' colspan='99' class=""forumRow"">暂无企业招聘</td></tr>"
  end if
  Response.Write "<tr>" & vbCrLf
