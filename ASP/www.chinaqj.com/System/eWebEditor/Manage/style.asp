...
s_FormAllowBrowse = InitSelect("d_allowbrowse", Split("开启|关闭", "|"), Split("1|0", "|"), sStyleAllowBrowse, "", "")
...
"<tr><td width='15%'>样式名称：</td><td width='35%'><input type=text size=20 name=d_name title='引用此样式的名字，不要加特殊符号' value=""" & sStyleName & """> <span class=red>*</span></td><td width='15%'>初始模式：</td><td width='35%'>" & s_FormInitMode & " <span class=red>*</span></td></tr>" & _
...
"<tr><td width='15%'>图片类型：</td><td width='35%'><input type=text class=input name=d_imageext size=35 title='用于图片相关的上传' value='" & sStyleImageExt & "'></td><td width='15%'>图片限制：</td><td width='35%'><input type=text class=input name=d_imagesize size=20 title='数字型，单位KB' value='" & sStyleImageSize & "'>KB</td></tr>" & _
"<tr><td width='15%'>Flash类型：</td><td width='35%'><input type=text class=input name=d_flashext size=35 title='用于插入Flash动画' value='" & sStyleFlashExt & "'></td><td width='15%'>Flash限制：</td><td width='35%'><input type=text class=input name=d_flashsize size=20 title='数字型，单位KB' value='" & sStyleFlashSize & "'>KB</td></tr>" & _
"<tr><td width='15%'>媒体类型：</td><td width='35%'><input type=text class=input name=d_mediaext size=35 title='用于插入媒体文件' value='" & sStyleMediaExt & "'></td><td width='15%'>媒体限制：</td><td width='35%'><input type=text class=input name=d_mediasize size=20 title='数字型，单位KB' value='" & sStyleMediaSize & "'>KB</td></tr>" & _
"<tr><td width='15%'>附件类型：</td><td width='35%'><input type=text class=input name=d_fileext size=35 title='用于插入附件' value='" & sStyleFileExt & "'></td><td width='15%'>附件限制：</td><td width='35%'><input type=text class=input name=d_filesize size=20 title='数字型，单位KB' value='" & sStyleFileSize & "'>KB</td></tr>" & _
"<tr><td width='15%'>远程类型：</td><td width='35%'><input type=text class=input name=d_remoteext size=35 title='用于自动上传远程文件' value='" & sStyleRemoteExt & "'></td><td width='15%'>远程限制：</td><td width='35%'><input type=text class=input name=d_remotesize size=20 title='数字型，单位KB' value='" & sStyleRemoteSize & "'>KB</td></tr>" & _
"<tr><td width='15%'>本地类型：</td><td width='35%'><input type=text class=input name=d_localext size=35 title='用于自动上传本地文件' value='" & sStyleLocalExt & "'></td><td width='15%'>本地限制：</td><td width='35%'><input type=text class=input name=d_localsize size=20 title='数字型，单位KB' value='" & sStyleLocalSize & "'>KB</td></tr>" & _
...
"<b>绝对全路径：</b>指所有的相关上传或自动插入文件路径，编辑后都以""http://域名/eWebEditor/UploadFile/...""这种形式呈现，当使用此模式时，显示路径和内容路径不必填。<br>" & _
...
"<tr><td><textarea rows=5 cols=65 style='width:100%'><iframe id=""eWebEditor1"" src=""ewebeditor.htm?id=ID&style=" & sStyleName & """ frameborder=""0"" scrolling=""no"" width=""" & sStyleWidth & """ height=""" & sStyleHeight & """></iframe></textarea></td></tr>" & _
"</table>"
End Sub
Sub ShowToolBarList()
...
<table border="0" cellpadding="5" cellspacing="0" align="center">
    <form action='?action=buttonsave&id=<%=sStyleID%>&toolbarid=<%=sToolBarID%>' method="post"
    name="myform">
    <tr align="center">
        <td>
            可选按钮
    ...
    <tr>
        <td>
            <div id="div1" style="border-right: 1.5pt inset; padding-right: 0px; border-top: 1.5pt inset;
                padding-left: 0px; padding-bottom: 0px; overflow: auto; border-left: 1.5pt inset;
                width: 250px; padding-top: 0px; border-bottom: 1.5pt inset; height: 350px; background-color: white">
            </div>
        </td>
        <td>
        ...
        <td>
            <div id="div2" style="border-right: 1.5pt inset; padding-right: 0px; border-top: 1.5pt inset;
                padding-left: 0px; padding-bottom: 0px; overflow: auto; border-left: 1.5pt inset;
                width: 250px; padding-top: 0px; border-bottom: 1.5pt inset; height: 350px; background-color: white">
            </div>
        </td>
        <td>
            <input type="button" name="b3" value='↑' onclick='Up()'><br>
            <br>
            <br>
    ...
    <tr>
        <td colspan="4" align="right">
            <input type="submit" name="b" value=' 保存设置 '>
        </td>
    </tr>
    </form>
</table>
