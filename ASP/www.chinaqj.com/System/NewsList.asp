...
<%
	'Call BetaNewSo("NewsList.asp","","NewFlagCh","新品")
	'Call BetaNewSo("NewsList.asp","","CommendFlagCh","推荐")
	Call BetaNewSo("NewsList.asp","NOT ","ViewFlagCh","中文未显示")
	Call BetaNewSo("NewsList.asp","NOT ","ViewFlagEn","英文未显示")
	Call BetaNewSo("NewsList.asp","NOT ","ViewFlagJp","日文未显示")
%>
  </td></tr>
  </form>
</table>
...
function GetNewsList()
	...
	If request.QueryString("Result")="Search" and request.QueryString("Keyword")<>"" Then				'搜索关键字
		SqlWhere=" NewsNameCh LIKE '%"&request.QueryString("Keyword")&"%'"	'where
	End If
	...
	Else
		Do While Not rs.eof
			...
			Response.write "		<td nowrap title='"&rs("NewsNameCh")&"' class=""forumRow"">"
			Response.write "			<a href='NewsEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&StrLeft(rs("NewsNameCh"),37)&"</a>"
			Response.write "		</td><td nowrap align=""center"" class=""forumRow"">"
			if rs("NoticeFlag") Then Response.write "<font color='red'>公告</font>" Else Response.Write "<font color='red'>新闻</font>" End If
			Response.write "		</td>"
			...
			if StrLen((rs("SourceCh")))>13 Then
				Response.Write "<td nowrap title='来源：&#13;"&rs("SourceCh")&"' class=""forumRow"">"&StrLeft(rs("SourceCh"),10)&"</td>"
			Else
				Response.Write "<td nowrap title='来源：&#13;"&rs("SourceCh")&"' class=""forumRow"">"&rs("SourceCh")&"</td>"
			end if 
			Response.Write "<td nowrap class=""forumRow"">"&rs("AddTime")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("ClickNumber")&"</td>"
			Response.Write "<td align=""center""nowrap class=""forumRow""><a href='NewsEdit.asp?Result=Modify&ID="&rs("ID")&"'>修改</a></td>"
