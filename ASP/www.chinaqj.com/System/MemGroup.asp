...
function GetMMGroupList()
	...
	Else
		Do While Not rs.eof
			...
			Response.Write "<td nowrap class=""forumRow"">"&rs("GroupID")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("GroupNameCh")&"</td>"
			Response.Write "<td nowrap class=""forumRow""><font color='blue'>"&rs("GroupLevel")&"</font></td>"
			if len(rs("Explain"))>24 Then
				Response.Write "<td nowrap title='"&rs("Explain")&"' class=""forumRow"">"&left(rs("Explain"),22)&"…</td>"
			Else
				Response.Write "<td nowrap title='"&rs("Explain")&"' class=""forumRow"">"&rs("Explain")&"</td>"
			end if 
			Response.Write "<td nowrap class=""forumRow"">"&rs("AddTime")&"</td>"
			Response.Write "<td align=""center""nowrap class=""forumRow""><a href='MemGroup.asp?Result=Modify&ID="&rs("ID")&"'>修改会员组别改</a></td>"
			if rs("ID")=1 or rs("ID")=2 Then
				Response.Write "<td nowrap align='center' class=""forumRow""><font color=""red"">×</font></td>"
			Else
				Response.Write "<td nowrap align='center' class=""forumRow""><input name='selectID' type='checkbox' value='"&rs("GroupID")&"'></td>"
			End If
			Response.Write "</tr>"
