...
function GetLogList()
	...
	Else
		Do While Not rs.eof
			...
			Response.Write "<td nowrap class=""forumRow"">"&rs("LoginIP")&"</td>"
			if len(rs("LoginSoft"))>50 Then
				Response.Write "<td nowrap class=""forumRow"" title=""浏览器："&rs("LoginSoft")&""">"&left(rs("LoginSoft"),50)&"…</td>"
			Else
				Response.Write "<td nowrap class=""forumRow"" title=""浏览器："&rs("LoginSoft")&""">"&rs("LoginSoft")&"</td>"
			End If
			Response.Write "<td nowrap class=""forumRow"">"&rs("LoginTime")&"</td>"
