...
<%
	'Call BetaNewSo("DownList.asp","","NewFlagCh","新品")
	'Call BetaNewSo("DownList.asp","","CommendFlagCh","推荐")
	Call BetaNewSo("DownList.asp","NOT ","ViewFlagCh","中文未显示")
	Call BetaNewSo("DownList.asp","NOT ","ViewFlagEn","英文未显示")
	Call BetaNewSo("DownList.asp","NOT ","ViewFlagJp","日文未显示")
%>
  </td></tr>
  </form>
</table>
...
function GetDownList()
	...
	If request.QueryString("Result")="Search" and request.QueryString("Keyword")<>"" Then				'搜索关键字
		SqlWhere=" DownNameCh LIKE '%"&request.QueryString("Keyword")&"%'"	'where
	End If
	...
	Else
		Do While Not rs.eof
			...
			if StrLen((rs("DownNameCh")))>40 Then
				Response.Write "<td nowrap title='"&rs("DownNameCh")&"' class=""forumRow"" width=""50%""><a href='DownEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&StrLeft(rs("DownName"),37)&"</a></td>"
			Else
				Response.Write "<td nowrap title='"&rs("DownNameCh")&"' class=""forumRow"" width=""50%""><a href='DownEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&rs("DownNameCh")&"</a></td>"
			end if 
			Response.Write "<td nowrap align=""center"" class=""forumRow"">"
			...
			if rs("Exclusive")=">=" Then
				Response.Write "<td nowrap align=""center"" class=""forumRow"">"&ViewGroupName(rs("GroupID"))&" <font color='green'>隶</font></td>"
			Else
				Response.Write "<td nowrap align=""center"" class=""forumRow"">"&ViewGroupName(rs("GroupID"))&" <font color='red'>专</font></td>"
			end If
			
			Response.Write "<td nowrap class=""forumRow"">"&rs("FileSize")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("ClickNumber")&"</td>"
			Response.Write "<td align=""center""nowrap class=""forumRow""><a href='DownEdit.asp?Result=Modify&ID="&rs("ID")&"'>修改</a></td>"
...
set rs2=nothing
	  if StrLen((rs("DownNameCh")))>40 then
        Response.Write "<td nowrap title='"&rs("DownNameCh")&"' class=""forumRow"" width=""50%""><a href='DownEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&StrLeft(rs("DownName"),37)&"</a></td>" & vbCrLf
      else
        Response.Write "<td nowrap title='"&rs("DownNameCh")&"' class=""forumRow"" width=""50%""><a href='DownEdit.asp?Result=Modify&ID="&rs("ID")&"''>"&rs("DownNameCh")&"</a></td>" & vbCrLf
      end if 
      ...
      Response.Write "<td align=""center""nowrap class=""forumRow""><a href='DownEdit.asp?Result=Modify&ID="&rs("ID")&"'>修改</a></td>" & vbCrLf
    ...
    response.write "<tr><td nowrap align='center' colspan='99' class=""forumRow"">暂无相关下载</td></tr>"
  end if
  Response.Write "<tr>" & vbCrLf
