...
<div style="width:100%;height:550px;" align="center">
	<div id="div_showInfo" style="width:80%; height:500px; overflow:auto; border: 3px solid #CCC; padding:5px;" align="left">
...
<%
	...
	Else
		Response.write("<script>var tm=3; function Nx(){bar_txt1.innerHTML='当前模块生成成功! 正准备生成下一模块...'+tm+'&nbsp;&nbsp;&nbsp;&nbsp;如果页面没有刷新,请<a href="""&url&""">点击此处</a>'; tm=tm-1;setTimeout('Nx()',1000);}</script>")
		Response.write("<script>Nx(); setTimeout(function(){document.location='"&url&"';},3000);</script>")
	End If
