...
function GetAdminList()
	...
	Else
		Do While Not rs.eof
			...
			Response.Write "<td nowrap class=""forumRow"">"&rs("AdminName")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("UserName")&"</td>"
			if len(rs("AdminPurview"))>28 Then
				Response.Write "<td nowrap title='"&rs("Explain")&"' class=""forumRow"">"&left(rs("AdminPurview"),25)&"…</td>"
			Else
				Response.Write "<td nowrap title='"&rs("Explain")&"' class=""forumRow"">"&rs("AdminPurview")&"</td>"
			end If
			Response.Write "<td nowrap class=""forumRow"">"&rs("LastLoginTime")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("LastLoginIP")&"</td>"
			Response.Write "<td nowrap class=""forumRow"">"&rs("AddTime")&"</td>"
			Response.Write "<td align=""center""nowrap class=""forumRow""><a href='AdminEdit.asp?Result=Modify&ID="&rs("ID")&"'>修改</a></td>"
			if rs("ID")=1 Then
