...
<%
if Instr(session("AdminPurview"),"|49,")=0 then
...
<table class="tableBorder" width="95%" border="0" align="center" cellpadding="5" cellspacing="1">
  <form action="DelContent.Asp?Result=Subsidiary" method="post" name="formDel">
    <tr>
      <th width="8">ID</th>
      <th width="50">排序</th>
      <th align="left">子公司标识</th>
      <th align="left" width="180">添加时间</th>
      <th width="50">操作</th>
      <th width="30">选择</th>
    </tr>
<% SubsidiaryList() %>
...
<td nowrap class="centerrow"><%= rs("Sequence") %></td>
<td nowrap class="leftrow"><%= rs("SubsidiaryCh") %>|<%= rs("SubsidiaryEn") %></td>
<td nowrap class="leftrow"><%= rs("AddTime") %></td>
<td nowrap class="centerrow"><a href='Admin_SubSidiaryEdit.Asp?Result=Modify&ID=<%= rs("id") %>'>修改</a><input name="pro_id" type="hidden" value="<%= rs("id") %>"></td>
